...
\begin{frame}{Motivation}
    \begin{itemize}
        ...
        \begin{enumerate}[label=\arabic*.] 
            \item Subsidies for private adaptation measures $\rightarrow$ increase adaptation towards social optimum vs. windfall gains
            \item Disaster relief programs $\rightarrow$ safety net for uninsured households vs. lower incentive to insure
        \end{enumerate}
