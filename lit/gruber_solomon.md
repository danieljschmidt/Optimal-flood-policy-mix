...
|---|---|---|
| FEMA spillover $\beta_{\mathrm{cond}}$ | −\$173 (OLS) / **−\$216 (IV)** per house per 1pp coverage, conditional on flood; implies $f\approx 0.133$. Appendix Tables A2–A6 decompose the IV total by program: IHP −\$183.4 (85%), HMGP −\$21.4 (10%), SBA −\$9.3 (4%), Fannie Mae −\$1.7, Freddie Mac +\$0.5 (wrong sign, n.s.) | County-flood panel 2010–, flexible damage controls; IV = Gallagher-style neighbor-county flood in past 5 years (salience shifts own-county coverage by ~3pp off an 18pp base) |
